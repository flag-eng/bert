...
def main():
    ...
    model = BertForSequenceClassification.from_pretrained("../chinese_L-12_H-768_A-12", num_labels=len(label_list))
    ...
    #BertForSequenceClassification 里面已经有了一个 CrossEntropyLoss() ，不用实例化损失函
